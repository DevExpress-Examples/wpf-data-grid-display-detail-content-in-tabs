...
Namespace WpfApplication18
	...
	Partial Public Class MainWindow
		...
		Private Sub AddDetailsToGrid(ByVal grid As GridControl)
			...
			contentDetail.ContentTemplate = DirectCast(FindResource("EmployeeNotes"), DataTemplate)
...
'INSTANT VB NOTE: The field employees was renamed since Visual Basic does not allow fields to have the same name as other class members:
		...
		Private Sub PopulateEmployees()
			...
			employees_Conflict(0).Orders.Add(New Order("Suppliers Inc.", DateTime.Now, "TV", 20))
			employees_Conflict(0).Orders.Add(New Order("Suppliers Inc.", DateTime.Now.AddDays(3), "Projector", 15))
			...
			employees_Conflict(1).Orders.Add(New Order("Suppliers Inc.", DateTime.Now.AddDays(1), "Blu-Ray Player", 10))
		End Sub
